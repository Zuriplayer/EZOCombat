...
- Iconos HUD creados desde una habilidad de la ventana. Se pueden mover y desactivar con su botón `X` o mediante el editor de habilidad seleccionada en LAM.
...
4. Ajusta **Tamaño de los iconos HUD** en LAM si lo necesitas y arrastra un icono visible a la posición HUD deseada. Usa su botón `X` o la casilla LAM de la habilidad seleccionada para desactivarlo.
